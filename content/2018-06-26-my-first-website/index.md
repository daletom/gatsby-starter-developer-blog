...
date: 2018-06-26
tags: [githubpages, imgix]
path: blog/my-first-website
cover: ./preview.png
excerpt: Building your first website with Github Pages.
---

I recently built my first website [TheDales](https://thedales.me/) app using [create-react-app](https://github.com/facebook/create-react-app 'create-react-app repository'). I didn’t need to muck about with Webpack, or “eject” my app, either. I’ll walk you through how I accomplished this.
